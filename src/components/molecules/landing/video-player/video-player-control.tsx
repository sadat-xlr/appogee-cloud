...
import { Fullscreen } from '@/components/atoms/icons/full-screen';
import { FullscreenExit } from '@/components/atoms/icons/full-screen-exit';
import { Mute } from '@/components/atoms/icons/mute';
import { Pause } from '@/components/atoms/icons/pause';
import { Play } from '@/components/atoms/icons/play';
import { Speaker } from '@/components/atoms/icons/speaker';
...
export function VideoPlayerControl({
  ...
  return (
    <>
      <Box className="flex gap-10 2xl:mb-3 sm:mb-2 mb-1.5 justify-between">
        <Box className="w-full ps-0.5">
          <RangeSlider
      ...
      <Box className="flex items-center gap-3 sm:gap-5 2xl:gap-6">
        <ActionIcon
        ...
        <Box className="flex items-center gap-2 sm:gap-3 2xl:gap-4">
          <ActionIcon
        ...
        <Text
          as="span"
          className="select-none text-[10px] sm:text-xs 2xl:text-sm font-normal"
        >
