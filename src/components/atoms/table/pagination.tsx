...
const classes = {
  base: {
    item: '[&>.rc-pagination-item>a]:text-steel-700 dark:[&>.rc-pagination-item>a]:text-steel-200 [&>.rc-pagination-item>a]:font-medium [&>li.rc-pagination-item]:border-muted [&>.rc-pagination-item>a]:hover:text-steel-900 [&>.rc-pagination-item>a]:focus:text-steel-700 [&>.rc-pagination-item:not(.rc-pagination-item-active)]:bg-transparent',
    ...
    jumperDiv:
      '[&>.rc-pagination-options>.rc-pagination-options-quick-jumper]:text-sm [&>.rc-pagination-options>.rc-pagination-options-quick-jumper]:text-steel-500',
    jumperInput:
  ...
  >
    {icon ?? (
      <svg
        ...
        strokeWidth={2}
        stroke="currentColor"
        className="w-4 h-4 m-auto rtl:-rotate-180"
      >
        <path
          strokeLinecap="round"
