export function ZipFileIcon(props: React.SVGAttributes<{}>) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill="#FF3E4C" d="M34.753 63.574h6.36v-6.36h-6.36v6.36Z" />
      <path fill="#FF3E4C" d="M41.098 57.219h6.36v-6.36h-6.36v6.36Z" />
      <path fill="#FF3E4C" d="M34.753 50.863h6.36v-6.36h-6.36v6.36Z" />
      <path fill="#FF3E4C" d="M41.098 44.508h6.36v-6.36h-6.36v6.36Z" />
    </svg>
  );
}
